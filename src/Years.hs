...
import Year2016.Day08 qualified (runDay)
import Year2016.Day09 qualified (runDay)
...
import Year2017.Day06 qualified (runDay)
import Year2017.Day07 qualified (runDay)
import Year2017.Day08 qualified (runDay)
import Year2017.Day09 qualified (runDay)
...
import Year2018.Day06 qualified (runDay)
import Year2018.Day07 qualified (runDay)
import Year2018.Day08 qualified (runDay)
import Year2018.Day09 qualified (runDay)
import Year2018.Day10 qualified (runDay)
...
import Year2019.Day06 qualified (runDay)
import Year2019.Day07 qualified (runDay)
import Year2019.Day08 qualified (runDay)
import Year2019.Day09 qualified (runDay)
import Year2019.Day10 qualified (runDay)
import Year2019.Day11 qualified (runDay)
import Year2019.Day13 qualified (runDay)
...
import Year2019.Day23 qualified (runDay)
import Year2019.Day25 qualified (runDay)
import Year2020.Day05 qualified (runDay)
import Year2020.Day06 qualified (runDay)
import Year2020.Day07 qualified (runDay)
import Year2020.Day08 qualified (runDay)
...
year2016 =
  fromList
    [ (1, Year2016.Day01.runDay),
      ...
      (8, Year2016.Day08.runDay),
      (9, Year2016.Day09.runDay)
    ]
...
year2017 =
  fromList
    [ (1, Year2017.Day01.runDay),
      ...
      (6, Year2017.Day06.runDay),
      (7, Year2017.Day07.runDay),
      (8, Year2017.Day08.runDay),
      (9, Year2017.Day09.runDay)
    ]
...
year2018 =
  fromList
    [ (1, Year2018.Day01.runDay),
      ...
      (6, Year2018.Day06.runDay),
      (7, Year2018.Day07.runDay),
...
year2019 =
  fromList
    [ (1, Year2019.Day01.runDay),
      ...
      (6, Year2019.Day06.runDay),
      (7, Year2019.Day07.runDay),
      (8, Year2019.Day08.runDay),
      (9, Year2019.Day09.runDay),
      (10, Year2019.Day10.runDay),
      (11, Year2019.Day11.runDay),
      (13, Year2019.Day13.runDay),
      (15, Year2019.Day15.runDay),
      (17, Year2019.Day17.runDay),
      (19, Year2019.Day19.runDay),
      (21, Year2019.Day21.runDay),
      (23, Year2019.Day23.runDay),
      (25, Year2019.Day25.runDay)
    ]

year2020 :: Map DayNumber Day
year2020 =
  fromList
    [ (5, Year2020.Day05.runDay),
      (6, Year2020.Day06.runDay),
      (7, Year2020.Day07.runDay),
      (8, Year2020.Day08.runDay)
    ]
